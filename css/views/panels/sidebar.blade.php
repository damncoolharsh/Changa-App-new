        ...
        <li>
            ...
            <ul class="nav-link dropdown-container"
                ...
                <li>
                    <a type="button"
                        class="nav-link dropdown-btn">
                        <i class="zmdi zmdi-account-circle"></i><span>Facilitator <i
                    ...
                    <ul class="nav-link dropdown-container"
                        ...
                        <li>
                            <a href="{{ route('mediator_category') }}"
                                ...
                                <i class="zmdi zmdi-account-circle"></i><span>Facilitator Category</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('mediators') }}"
                                class=" nav-link {{ Request::segment(1) == 'mediators' ? 'active' : '' }}">
                                <i class="zmdi zmdi-account-circle"></i><span>Facilitator</span>
                            </a>
                        </li>
                    </ul>
                </li>
